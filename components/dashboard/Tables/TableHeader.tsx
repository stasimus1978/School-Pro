...
export default function TableHeader({ title, href, linkTitle, data, model, showImport = true }: TableHeaderProps) {
          ...
          {showImport && (
            <Dialog>
              <DialogTrigger asChild>
                <Button onClick={() => setUploadSuccess(false)} size="sm" variant="outline" className="h-8 gap-1">
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription className="text-xs">
                      You can Bring all your Data from excel, Please Download the Sample file First to Make Sure you
                      have Data Columns Named Correctly
                    </DialogDescription>
                  </DialogHeader>
