...
export default function DateFilters({ data, onFilter, setIsSearch }: { data: any[]; onFilter: any; setIsSearch: any }) {
  const options = [
  ...
  return (
    <div>
      <Select value={selectedFilter} onChange={handleChange} options={options} primaryColor={"indigo"} />
    </div>
  );
}
