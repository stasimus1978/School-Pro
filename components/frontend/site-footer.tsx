    ...
    <footer className="w-full bg-[#6366F1] text-white">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-white/90">
              From admissions to academics, simplify your school management with Pagedone. A complete solution for your
              school.
            </p>
      ...
      <div className="border-t border-white/10">
        <div className="container flex flex-col items-center justify-center gap-4 py-6 text-center text-sm md:h-16 md:flex-row md:py-0">
          <div className="text-white/60">Copyright@{new Date().getFullYear()} All Right Reserved Pagedone.</div>
        </div>
      </div>
    </footer>
  );
